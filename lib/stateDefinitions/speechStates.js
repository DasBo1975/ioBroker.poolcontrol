...
async function createSpeechStates(adapter) {
    ...
    await adapter.setStateAsync("speech.active", { val: adapter.config.speech_active ?? false, ack: true });
    ...
    await adapter.setStateAsync("speech.start_text", { val: "Die Poolpumpe wurde gestartet.", ack: true });
    ...
    await adapter.setStateAsync("speech.end_text", { val: "Die Poolpumpe wurde gestoppt.", ack: true });
