...
async function createSolarStates(adapter) {
    ...
    await adapter.setStateAsync("solar.solar_control_active", { val: adapter.config.solar_control_active, ack: true });
    ...
    await adapter.setStateAsync("solar.hysteresis_active", { val: adapter.config.solar_hysteresis_active, ack: true });
    ...
    await adapter.setStateAsync("solar.temp_on", { val: adapter.config.solar_temp_on, ack: true });
    ...
    await adapter.setStateAsync("solar.temp_off", { val: adapter.config.solar_temp_off, ack: true });
    ...
    await adapter.setStateAsync("solar.collector_warning", { val: false, ack: true });
