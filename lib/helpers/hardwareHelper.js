                ...
                if (id === manualPath && state && typeof state.val === 'string' && state.val.startsWith(code)) {
                    ...
                    try {
                        ...
                        for (const row of objects.rows) {
                            ...
                            } else if (name.includes('LED Grün') || name.includes('LED Betrieb')) {
                                deviceMap.led_green_path = id2;
                            } else if (name.includes('LED Blau') || name.includes('LED Verbindung')) {
                                deviceMap.led_blue_path = id2;
                            } else if (name.includes('LED Rot') || name.includes('LED Fehler')) {
                                deviceMap.led_red_path = id2;
                            }
                        }
