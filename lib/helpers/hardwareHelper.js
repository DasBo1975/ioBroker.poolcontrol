    ...
    async _searchAndHandshake(boxId) {
        ...
        try {
            ...
            for (const obj of objects.rows) {
                ...
                // typische Namen aus ESPHome/Adapter: "PoolControl Box-ID", "State of PoolControl Box-ID"
                const isBoxIdName =
                    commonName.includes('poolcontrol box-id') ||
                    (commonName.includes('box-id') && commonName.includes('poolcontrol'));
