...
const runtimeHelper = {
    ...
    async _updateStates() {
        try {
            ...
            await this.adapter.setStateAsync("runtime.total", { val: this.runtimeTotal, ack: true });
            await this.adapter.setStateAsync("runtime.today", { val: effectiveToday, ack: true });
            await this.adapter.setStateAsync("runtime.formatted", { val: this._formatTime(effectiveToday), ack: true });
