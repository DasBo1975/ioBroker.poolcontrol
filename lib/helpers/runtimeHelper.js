    ...
    async handleStateChange(id, state) {
        ...
        if (id.endsWith('pump.pump_switch')) {
            if (state.val && !this.isRunning) {
                ...
                // ------------------------------------------------------
                // NEU: Statuswerte bei Pumpenstart setzen
                // ------------------------------------------------------
                const nowStr = new Date().toLocaleString();
                await this.adapter.setStateAsync('status.pump_last_start', { val: nowStr, ack: true });
                await this.adapter.setStateAsync('status.pump_today_count', { val: this.startCountToday, ack: true });
                ...
                // ------------------------------------------------------
                // NEU: Statuswert bei Pumpenstopp setzen
                // ------------------------------------------------------
                const nowStr = new Date().toLocaleString();
