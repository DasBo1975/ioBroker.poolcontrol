...
const pumpHelper2 = {
    ...
    async handleStateChange(id, state) {
        ...
        // Grundregel: nur bestätigte Werte verarbeiten (ack:true)
        // Ausnahme: pump.pump_switch darf auch bei ack:false reagieren
        if (state.ack === false && !id.endsWith('pump.pump_switch')) {
            return;
        }
