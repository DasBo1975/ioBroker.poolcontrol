...
const pumpHelper4 = {
    ...
    async init(adapter) {
        ...
        // FIX: Eigene relevante States abonnieren
        adapter.subscribeStates('pump.pressure.learning.reset');
        adapter.subscribeStates('pump.pressure.normal_min_bar');
        adapter.subscribeStates('pump.pressure.normal_max_bar');
